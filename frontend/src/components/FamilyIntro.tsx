    ...
    <section className="bg-white py-16 px-6 overflow-hidden text-center relative">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-6 mb-3">
        ...
        >
          ...
          <p className="text-sm text-gray-600 font-secondary space-y-2">
            <div>
              L. Muneaswari - D. Lakshmipathi <br />
              Purusothaman - Nandini <br />
              L. Raghavan{" "}
              <span className="italic text-[12px]">Diploma, B.Voc.,</span>{" "}
              <br />
              M. Anandhi - D. Mani{" "}
